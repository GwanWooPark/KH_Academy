...
<body>
	...
	<form action="Weather.do" method="post" name="command">
	...
	//
	String[] fieldNames = { "temp", "wfKor", "pop", "hour", "day" };
	...
	try {
		...
		// XML로부터 DOM 객체 트리를 생성하기 위해

		//위에서 구성한 URL을 통해 XMl 파싱 시작
		Document doc = b.parse(url);
		doc.getDocumentElement().normalize();
		// DOM Tree가 XML 문서의 구조대로 완성이 된다.
	...
	for (int i = 0; i < pubList.size(); i++) {
		...
		// 모레 날씨 정보 받기
		if (tmpWfDay.equals("2") && tmpWfHour.equals("3")) {
			day2 = tmpday;
			wfKor2 = tmpWfKor;
			pop2 = tmppop;
			temp2 = tmpTemp;
		...
		if (tmpWfDay.equals("2") && tmpWfHour.equals("6")) {
			day2 = tmpday;
			wfKor2 = tmpWfKor;
			pop2 = tmppop;
			temp2 = tmpTemp;
		}
		if (tmpWfDay.equals("2") && tmpWfHour.equals("9")) {
			day2 = tmpday;
			wfKor2 = tmpWfKor;
			pop2 = tmppop;
			temp2 = tmpTemp;
	...
	<div class="outer_box">
		<div class="inner_box">
			...
			<div><%=wfKor%></div>
			<div>
				<img src= "resources/image_weather2/<%=wfKor%>.png" width="150" height="150">
			</div>
		...
		<div class="inner_box">
			...
			<div><%=wfKor1%></div>
			<div>
				<img src= "resources/image_weather2/<%=wfKor1%>.png" width="150" height="150">
			</div>
		...
		<div class="inner_box">
			...
			<div><%=wfKor2%></div>
			<div>
				<img src= "resources/image_weather2/<%=wfKor2%>.png" width="150" height="150">
			</div>
