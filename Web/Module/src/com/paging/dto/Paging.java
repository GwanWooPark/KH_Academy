...
public class Paging {
	...
	public void makePaging() {
		...
		// ������ ������
		System.out.println("nu : " + numberOfRecords + "re : " + recordsPerPage);
		int finalPage = (numberOfRecords + ((recordsPerPage * 2) - 1)) / (recordsPerPage * 2);
		
		System.out.println("final:final " + finalPage);
